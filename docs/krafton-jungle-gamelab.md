...
| 5 | **MechTarkov** (개인, 2년+ 진행) | UE5 익스트랙션 슈터 | 단독 (기획+개발) | Lyra/GAS, Obsidian 기획 문서, 장기 개인 프로젝트 |
| 6 | **WPF 마리오** (개인) | 물리·게임루프 직접 구현 | 단독 | AABB·스윕 충돌, 15ms 게임 루프 — 엔진 없는 기본기 |
| 7 | **AI 파이프라인 툴 연작** (개인) | 개발 생산성 도구 5종 | 단독 | 3D→픽셀아트, 3D→ControlNet, HTML→UGUI, 에이전트 관리 |
...
## 5. MechTarkov — UE5 익스트랙션 슈터 (개인, 2년+ 진행 중)

| | |
| --- | --- |
| 기간 | 2023 ~ 진행 중 |
| 역할 | 1인 (기획 + 개발) |
| 기술 | Unreal Engine 5, Lyra, GAS, Obsidian(기획 문서) |

- 2040년대 대구·경북 배경 포스트 아포칼립스 **익스트랙션 슈터 × 메카** — 장르 분석·세계관·프로젝트 규칙을 Obsidian으로 문서화
- 개발 연혁: 2023 프로토타입 → 2024 Lyra 기반 클라이언트(119커밋) → 2025 GAS 기반 C++ 재구현 → 에셋 통합(60GB)
- 8년 제작 이력 중 가장 오래 붙잡고 있는 프로젝트 — 기획→프로토타입→리팩터링→에셋 통합 사이클을 1인으로 경험 중

## 6. WPF 마리오 — 물리·게임 루프 직접 구현 (개인, 2021)
